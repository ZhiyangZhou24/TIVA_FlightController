...
//
//*****************************************************************************
extern unsigned int g_ui32SchedulerNumTasks;
...
extern void SchedulerInit(unsigned int ui32TicksPerSecond);
extern void SchedulerRun(void);
extern void SchedulerTaskEnable(unsigned int ui32Index, bool bRunNow);
extern void SchedulerTaskDisable(unsigned int ui32Index);
extern unsigned int SchedulerTickCountGet(void);
extern unsigned int SchedulerElapsedTicksGet(unsigned int ui32TickCount);
extern unsigned int SchedulerElapsedTicksCalc(unsigned int ui32TickStart,
                                               unsigned int ui32TickEnd);
