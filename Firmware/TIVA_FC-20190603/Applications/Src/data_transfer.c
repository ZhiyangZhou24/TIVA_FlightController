...
{
	UARTStringPut(UART0_BASE,data_to_send, length);
}
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_senser = 0;
		ANO_DT_Send_Senser(icm20602.Acc.x,icm20602.Acc.y,icm20602.Acc.z,
												icm20602.Gyro.x,icm20602.Gyro.y,icm20602.Gyro.z,
												//ist8310.Mag_Val.x,ist8310.Mag_Val.y,ist8310.Mag_Val.z,
												except_A.x,except_A.y,exp_height
		                   );
	}	
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_senser2 = 0;
		ANO_DT_Send_Senser2(baroAlt,ultra_distance*100);
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_pid3 = 0;
		ANO_DT_Send_PID(3,pid_setup.groups.sonar_hc_ctrl1.kp,pid_setup.groups.sonar_hc_ctrl1.ki,pid_setup.groups.sonar_hc_ctrl1.kd,
											pid_setup.groups.sonar_hc_ctrl2.kp,pid_setup.groups.sonar_hc_ctrl2.ki,pid_setup.groups.sonar_hc_ctrl2.kd,
											pid_setup.groups.position_ctrl1.kp,pid_setup.groups.position_ctrl1.ki,pid_setup.groups.position_ctrl1.kd);
	}
	else if(f.send_pid4)
	{
		f.send_pid4 = 0;
		ANO_DT_Send_PID(4,pid_setup.groups.position_ctrl2.kp,pid_setup.groups.position_ctrl2.ki,pid_setup.groups.position_ctrl2.kd,
											1						,2						,3						,
											4						,5						,6						);
	}
...
void ANO_DT_Data_Receive_Anl(u8 *data_buf,u8 num)
{
	...
	{	
		pid_setup.groups.sonar_hc_ctrl1.kp  = 0.001*( (vs16)(*(data_buf+4)<<8)|*(data_buf+5) );
		pid_setup.groups.sonar_hc_ctrl1.ki  = 0.001*( (vs16)(*(data_buf+6)<<8)|*(data_buf+7) );
		pid_setup.groups.sonar_hc_ctrl1.kd  = 0.001*( (vs16)(*(data_buf+8)<<8)|*(data_buf+9) );
	
		pid_setup.groups.sonar_hc_ctrl2.kp = 0.001*( (vs16)(*(data_buf+10)<<8)|*(data_buf+11) );
		pid_setup.groups.sonar_hc_ctrl2.ki = 0.001*( (vs16)(*(data_buf+12)<<8)|*(data_buf+13) );
		pid_setup.groups.sonar_hc_ctrl2.kd = 0.001*( (vs16)(*(data_buf+14)<<8)|*(data_buf+15) );
	
		pid_setup.groups.position_ctrl1.kp 	= 0.001*( (vs16)(*(data_buf+16)<<8)|*(data_buf+17) );
		pid_setup.groups.position_ctrl1.ki 	= 0.001*( (vs16)(*(data_buf+18)<<8)|*(data_buf+19) );
		pid_setup.groups.position_ctrl1.kd 	= 0.001*( (vs16)(*(data_buf+20)<<8)|*(data_buf+21) );
		if(f.send_check == 0)
		{
			f.send_check = 1;
			checkdata_to_send = *(data_buf+2);
	...
	{
		pid_setup.groups.position_ctrl2.kp  = 0.001*( (vs16)(*(data_buf+4)<<8)|*(data_buf+5) );
		pid_setup.groups.position_ctrl2.ki  = 0.001*( (vs16)(*(data_buf+6)<<8)|*(data_buf+7) );
		pid_setup.groups.position_ctrl2.kd  = 0.001*( (vs16)(*(data_buf+8)<<8)|*(data_buf+9) );
...
void ANO_DT_Send_Status(float angle_rol, float angle_pit, float angle_yaw, s32 alt, u8 fly_model, u8 armed)
{
	u8 _cnt=0;
	vs16 _temp;
	volatile signed int  _temp2 = alt;
